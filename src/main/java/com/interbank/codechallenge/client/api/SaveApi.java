...
public interface SaveApi {
    ...
    @ApiOperation(value = "", notes = "Save a client information", response = Client.class, tags={ "save", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Save OK", response = Client.class) })
    
    @RequestMapping(value = "/save",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<Client> save(@ApiParam(value = "Body client information" ,required=true )  @Valid @RequestBody Client client);
